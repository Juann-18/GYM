...
import Modelo.Admin.Md_RegistrarAdmin;
...
public class Ctr_RegistraAdmin implements ActionListener{
    RegistraAdmin np;
    public String tipo;
    int nu;

    public Ctr_RegistraAdmin(RegistraAdmin np, int nu) {
        this.np = np;
        this.nu = nu;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource().equals(np.regist)){
            ...
            Md_RegistrarAdmin modelo = new Md_RegistrarAdmin(this);
